...
public class PreparationXmlValidator extends DefaultHandler{
    public static final String SCHEMA_FILE_NAME = "medicinalPreparations.xsd";

    private StringBuilder error = new StringBuilder();

    private String fileName;

    public PreparationXmlValidator(String fileName) {
